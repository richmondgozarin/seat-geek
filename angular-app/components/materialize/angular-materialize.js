(function (angular) {
    angular.module("ui.materialize", ["ui.materialize.dropdown", "ui.materialize.inputfield", "ui.materialize.input_date", "ui.materialize.tabs", "ui.materialize.pagination", "ui.materialize.pushpin", "ui.materialize.parallax", "ui.materialize.tooltipped"]);
    ...
    angular.module("ui.materialize.input_date", [])
        .directive('datePicker', ["$compile", "$timeout", function ($compile, $timeout) {
